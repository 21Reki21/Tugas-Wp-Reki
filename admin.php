    ...
    <div class="col-md-4">
      <div class="main-menu">
        <ul class='main-menu'>
          ...
          <li>
            <a class="dis" id="2">
            <span class='glyphicon glyphicon-book'></span> Lihat Nilai
            </a>
          </li>
          <li>
            <a class="dis" id="3">
            <span class='glyphicon glyphicon-plus'></span> Tambah Mahasiswa
            </a>
          </li>
          <li>
            <a class="dis" id="4">
            <span class='glyphicon glyphicon-star'></span> Update Nilai
            </a>
          </li>
        </ul>
      </div>
